...
type
  TfrmMain = class(TForm)
    ...
    Menu_SamAndMax_SaveTheWorld_Common: TMenuItem;
    ...
    Menu_WalkingDead_TheDefinitiveSeriesMenu: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeriesMenuS2: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeriesMenuSM: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeriesProjectS1: TMenuItem;
    Menu_WalkingDead_TheDefinitiveSeriesProjectSM: TMenuItem;
